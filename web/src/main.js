...
addEventListener('keydown',e=>{keys[e.code]=true;
  if(e.code==='Space'||(!Game.isRace()&&e.code==='KeyE')){e.preventDefault();Game.tryPlant(0);}
  if(['Enter','NumpadEnter'].includes(e.code)){e.preventDefault();Game.tryPlant(Game.isRace()?1:0);}});
